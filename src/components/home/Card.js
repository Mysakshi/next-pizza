...
function Card(props) {
  ...
  return (
    <div className="box">
      <div className="w-80 rounded-lg bg-white overflow-hidden dark:bg-black border-gradient text-white">
        ...
        <div className="flex p-4 font-bold  justify-between">
          <button
            ...
            className="border dark:border-gray-400 border-gray-900 rounded p-2 hover:bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700  hover:text-gray-100 text-white "
          >
            Add to cart
          </button>
          <p className="p-2 text-xl text-white">₹{finalPrice}/-</p>
        </div>
      </div>
    </div>
  );
